...
let url = "https://recommend-it-backend.herokuapp.com/users"
...
function listUserQueries(user) {
    ...
    `<section id="header">
        ...
        <form class="filter-form" action="https://recommend-it-a09ec.web.app/UserPage.html?username=${user.username}&password=${user.password}">
        ...
        <form method="POST" action="https://recommend-it-a09ec.web.app/UserPage.html?username=${user.username}&password=${user.password}">
...
function searchQueries(sq, userHeader, user) {
    ...
    sq.forEach( query => {
        ...
        <form action="https://recommend-it-backend.herokuapp.com/search_queries/${query.id}" method = "POST">
...
function listRecommendations(query, userHeader, user){
    ...
    query.recommendations.forEach(recommendation => {
        ...
        recommendationList.innerHTML = 
            ...
            <button id="info-button${counter}">More Info</button>
            <form method="POST" action="https://recommend-it-backend.herokuapp.com/search_queries">
